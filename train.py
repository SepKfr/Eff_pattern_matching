...
class Train:
    ...
    def evaluate(self):
        ...
        error_path = "errors_{}_{}_2.json".format(self.exp_name, self.pred_len)
...
def main():
    ...
    parser.add_argument("--attn_type", type=str, default='KittyCatConv-no-trip')
    parser.add_argument("--name", type=str, default="KittyCatConv-no-trip")
